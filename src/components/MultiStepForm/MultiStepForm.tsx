...
import { CheckboxWithLabel, TextField, Select, TextFieldProps } from 'formik-material-ui';
          ...
          <FormikStep
            ...
            validationSchema={object({
              firstName: string()
                ...
                .max(6, `Your name can't be longer than 6 chars`),
...
export function FormikStepper<MyFormValues>({ children, ...props }: FormikConfig<MyFormValues>) {
